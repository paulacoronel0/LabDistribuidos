...
public class ServidorH extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                // Una vez que acepta la conexion, genera un nuevo hilo que se encargará de responder al cliente
    ...
    class ManejadorH implements Runnable {
        ...
        // Se crea un ManejadorH para cada cliente, para generar concurrencia en las consultas del horoscopo
